...
struct ContentView: View {
    @ObservedObject private var service = DynoPromptService.shared
    ...
    @State private var library = ScriptLibraryModel.shared
...
Welcome to DynoPrompt! This is your personal teleprompter that sits right below your MacBook's notch. [smile]
...
"""
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showLibrary) {
            ScriptLibraryView(
                ...
                onOpen: { script in
                    ...
                    service.pages = script.pages.isEmpty ? [""] : script.pages
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openScriptLibrary)) { _ in
            library.reload()
            showLibrary = true
        }
