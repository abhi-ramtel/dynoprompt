                ...
                Section("About") {
                    VStack(spacing: 12) {
                        ...
                        VStack(spacing: 3) {
                            Text("DynoPrompt")
                                .font(.title3.bold())
                            Text(DynoPromptAppInfo.versionLabel)
                                .font(.caption.monospacedDigit())
                                .foregroundStyle(.secondary)
                        }
                    ...
                    AboutLink(
                        title: "DynoPrompt for Mac",
                        subtitle: "Available on the Mac App Store",
                        systemImage: "macbook",
                        destination: DynoPromptAppInfo.macAppStoreURL,
                        accessibilityHint: "Opens the DynoPrompt for Mac App Store page"
                    )
