...
struct SavedRecordingsGallery: View {
                ...
                Group {
                    if store.isLoading {
                        ...
                        ContentUnavailableView(
                            ...
                            systemImage: "video",
                            description: Text(
                                "Videos you record with DynoPrompt will appear here after they are saved to Photos."
                            )
                        )
                    } else {
    ...
    private var photosAccessView: some View {
        ContentUnavailableView {
            ...
            Text("Allow Photos access to view and manage videos recorded with DynoPrompt.")
        } actions: {
