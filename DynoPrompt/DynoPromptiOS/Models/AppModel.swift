...
final class AppModel {
    ...
    Welcome to DynoPrompt for iPhone. [smile]

    Read naturally and DynoPrompt follows every word you say. Switch to Classic for steady auto-scrolling, or Voice-Activated to move only while you speak.
