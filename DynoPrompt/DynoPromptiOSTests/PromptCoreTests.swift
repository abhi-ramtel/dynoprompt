...
struct PromptCoreTests {
    ...
    func brandedLogoAssetLoadsFromTheAppBundle() {
        #expect(UIImage(named: "DynoPromptLogo") != nil)
    }

    @Test
    func aboutVersionLabelIncludesVersionAndBuild() {
        #expect(
            DynoPromptAppInfo.versionLabel(
                from: [
    ...
    @Test
    func aboutLinksToTheDynoPromptMacApp() {
        #expect(
            DynoPromptAppInfo.macAppStoreURL.absoluteString
    ...
    @MainActor
    @Test
    func savedRecordingStorePersistsOnlyDynoPromptAssetIdentifiers() {
    ...
    func nativeEditorTemporaryVideoCleanupIsIdempotent() throws {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("DynoPromptTrimCleanupTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func nativeEditorWorkspacesAreUniqueAndOwnAStableMovSource() throws {
        let temporaryRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("DynoPromptTrimWorkspaceTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func nativeEditorUsesThePreparedVideoAndDoesNotLimitTrimDuration() throws {
        let sourceURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("dynoprompt-native-editor-source.mov")
